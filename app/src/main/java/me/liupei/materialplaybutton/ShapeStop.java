 ...
 */
public class ShapeStop implements Shape{

    @Override
    public PointF[] getLeft(int size) {
        PointF points[] = new PointF[4];
        points[0] = new PointF(0.2f * size, 0.2f * size);
        points[1] = new PointF(0.5f * size, 0.2f * size);
        points[2] = new PointF(0.5f * size, 0.8f * size);
    ...
    public PointF[] getRight(int size) {
        PointF points[] = new PointF[4];
        points[0] = new PointF(0.5f * size, 0.2f * size);
        points[1] = new PointF(0.8f * size, 0.2f * size);
        points[2] = new PointF(0.8f * size, 0.8f * size);
        points[3] = new PointF(0.5f * size, 0.8f * size);
